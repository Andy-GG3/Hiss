...
const defaultMenu = {
before: `*ʜᴀʟʟᴏ ᴋᴀᴋ👋.* ɴᴀᴍᴀ ꜱᴀyᴀ ᴀᴅᴀʟᴀʜ *ʏᴀɴᴛᴏ ᴍᴅ* ʙᴏᴛ ʙy *ᴀɴᴅʏ*
...
await conn.sendFile(m.chat, './mp3/menu2.mp3', 'menu', null, m, true)  
        // Biasa
} catch (e) {
...
handler.command = /^(menu|andyy|andy|yanto)$/i
